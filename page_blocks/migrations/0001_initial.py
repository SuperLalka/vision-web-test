    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container_bg_color', models.CharField(blank=True, max_length=20, null=True)),
                ('content_bg_color_major', models.CharField(blank=True, max_length=20, null=True)),
                ('content_bg_color_minor', models.CharField(blank=True, max_length=20, null=True)),
                ('title_font_size', models.CharField(blank=True, max_length=20, null=True)),
                ('title_font_color', models.CharField(blank=True, max_length=20, null=True)),
                ('text_font_size', models.CharField(blank=True, max_length=20, null=True)),
                ('text_font_color_major', models.CharField(blank=True, max_length=20, null=True)),
                ('text_font_color_minor', models.CharField(blank=True, max_length=20, null=True)),
                ('button_bg_color', models.CharField(blank=True, max_length=20, null=True)),
                ('button_font_size', models.CharField(blank=True, max_length=20, null=True)),
                ('button_font_color', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list_items', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), blank=True, null=True, size=5)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_group', models.CharField(choices=[('reader', 'Reader'), ('client', 'Client'), ('admin', 'Admin')], default='Reader', help_text='Select user group', max_length=10)),
